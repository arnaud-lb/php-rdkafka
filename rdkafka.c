...
void register_err_constants(INIT_FUNC_ARGS) /* {{{ */
{
    ...
    COPY_CONSTANT(RD_KAFKA_RESP_ERR__NODE_UPDATE);
    COPY_CONSTANT(RD_KAFKA_RESP_ERR__SSL);
    COPY_CONSTANT(RD_KAFKA_RESP_ERR__WAIT_COORD);
    COPY_CONSTANT(RD_KAFKA_RESP_ERR__UNKNOWN_GROUP);
    COPY_CONSTANT(RD_KAFKA_RESP_ERR__IN_PROGRESS);
    COPY_CONSTANT(RD_KAFKA_RESP_ERR__PREV_IN_PROGRESS);
    COPY_CONSTANT(RD_KAFKA_RESP_ERR__EXISTING_SUBSCRIPTION);
    COPY_CONSTANT(RD_KAFKA_RESP_ERR__ASSIGN_PARTITIONS);
    COPY_CONSTANT(RD_KAFKA_RESP_ERR__REVOKE_PARTITIONS);
    COPY_CONSTANT(RD_KAFKA_RESP_ERR__CONFLICT);
    COPY_CONSTANT(RD_KAFKA_RESP_ERR__STATE);
    COPY_CONSTANT(RD_KAFKA_RESP_ERR__UNKNOWN_PROTOCOL);
    COPY_CONSTANT(RD_KAFKA_RESP_ERR__NOT_IMPLEMENTED);
    COPY_CONSTANT(RD_KAFKA_RESP_ERR__AUTHENTICATION);
    COPY_CONSTANT(RD_KAFKA_RESP_ERR__NO_OFFSET);
