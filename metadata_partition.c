...
PHP_METHOD(RdKafka__Metadata__Partition, getReplicas)
{
    ...
    kafka_metadata_iterator_init(return_value, this_ptr, intern->metadata_partition->replicas, intern->metadata_partition->replica_cnt, sizeof(*intern->metadata_partition->replicas), int32_ctor);
}
/* }}} */
...
PHP_METHOD(RdKafka__Metadata__Partition, getIsrs)
{
    ...
    kafka_metadata_iterator_init(return_value, this_ptr, intern->metadata_partition->isrs, intern->metadata_partition->isr_cnt, sizeof(*intern->metadata_partition->isrs), int32_ctor);
}
/* }}} */
