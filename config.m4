...
if test "$PHP_RDKAFKA" != "no"; then
  ...
  PHP_NEW_EXTENSION(rdkafka, rdkafka.c metadata.c metadata_broker.c metadata_topic.c metadata_partition.c metadata_collection.c compat.c conf.c, $ext_shared)
fi
