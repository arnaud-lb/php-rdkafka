...
if test "$PHP_RDKAFKA" != "no"; then
  ...
  SOURCES="rdkafka.c metadata.c metadata_broker.c metadata_topic.c metadata_partition.c metadata_collection.c compat.c conf.c topic.c queue.c message.c fun.c rdkafka_instances.c"
